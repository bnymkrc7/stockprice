# 💻 GELİŞTİRİCİ GÖREVİ: FAZ_3 — Model Mimarileri — PyTorch (Süre: ~2-3 saat)
...
1. Geliştirici Ajan işe başlamadan önce `fazlar/TASKS.md` dosyasındaki FAZ_3 görevini `[/]` (devam ediyor) olarak işaretlesin.
2. Yukarıda belirtilen kodlama hedeflerini, modülerlik ve veri sızıntısını önleme kurallarına uyarak kodlayın.
3. Çalışma bittiğinde `working/done_faz_3.md` adında bir done dosyası oluşturarak yapılan işleri özetleyin.
