# 💻 GELİŞTİRİCİ GÖREVİ: FAZ_6 — Karşılaştırma & İyileştirme (Süre: ~2-3 saat)
...
1. Geliştirici Ajan işe başlamadan önce `fazlar/TASKS.md` dosyasındaki FAZ_6 görevini `[/]` (devam ediyor) olarak işaretlesin.
2. Yukarıda belirtilen kodlama hedeflerini, modülerlik ve veri sızıntısını önleme kurallarına uyarak kodlayın.
3. Çalışma bittiğinde `working/done_faz_6.md` adında bir done dosyası oluşturarak yapılan işleri özetleyin.
